...
import com.example.noteappyt.navigation.navgraph.favorites
import com.example.noteappyt.navigation.navgraph.notes
...
fun AppNavigation(){
    ...
    val isBottomAppBarVisible = rememberSaveable(navBackStackEntry) {
        ...
        navBackStackEntry?.destination?.route == Screen.FavoriteScreen.route
    }
